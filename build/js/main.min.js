...
window.addEventListener('DOMContentLoaded', function () {
  ...
  (0, _scroll.priceSection)();
  (0, _selectMonth.handleClick)();
...
},{"./modules/form-validate/form":3,"./scroll":9,"./selectMonth":10,"./utils/ios-vh-fix":12}],2:[function(require,module,exports){
"use strict";
...
var buttonBuy = document.querySelector('.hero__button');
var priceSection = exports.priceSection = document.querySelector('.price');
...
// buttonMonth1.addEventListener('click', function handleClick() {
//   const initialText = '2000';
// });
