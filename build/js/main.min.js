...
window.addEventListener('DOMContentLoaded', function () {
  ...
  window.addEventListener('load', function () {
    ...
    window.form = form;
    form.init();
    (0, _scroll.scrollPriceSection)();
    (0, _slider.initSliderJury)();
  });
});
...
},{"./modules/form-validate/form":3,"./modules/scroll":9,"./modules/slider":10,"./utils/ios-vh-fix":12}],2:[function(require,module,exports){
"use strict";
...
exports.scrollPriceSection = void 0;
var buttonBuy = document.querySelector('[data-buy="price"]');
var scrollPriceSection = exports.scrollPriceSection = document.querySelector('[data-price="btn"]');
...
var initSliderJury = exports.initSliderJury = function initSliderJury() {
  var gallarySlider = document.querySelector('[data-swiper="jury"]');
  var btnPrev = document.querySelector('[data-button="prev"]');
  var btnNext = document.querySelector('[data-button="next"]');
  // eslint-disable-next-line no-constant-condition
  if (gallarySlider) {
    // eslint-disable-next-line no-new
    new _swiper.default(gallarySlider, {
      navigation: {
        nextEl: btnPrev,
        prevEl: btnNext
      },
